...
namespace ChiefMod.Modules
{
    internal static class Assets
    {
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ChiefMod." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("ChiefMod.ChiefBank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            swordHitSoundEvent = CreateNetworkSoundEventDef("ChiefSwordHit");

            bombExplosionEffect = LoadEffect("BombExplosionEffect", "ChiefBombExplosion");
            ...
            swordSwingEffect = Assets.LoadEffect("ChiefSwordSwingEffect", true);
            swordHitImpactEffect = Assets.LoadEffect("ImpactChiefSlash");
        }
