...
namespace ChiefMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = ChiefPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = ChiefPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = ChiefPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = ChiefPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            ChiefPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            ChiefPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            ChiefPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
