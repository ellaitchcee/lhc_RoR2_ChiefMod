...
namespace ChiefMod.Modules.Survivors
{
    internal class ChiefCharacter : SurvivorBase
    {
        internal override string bodyName { get; set; } = "Chief";
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            ...
            armorGrowth = 0f,
            bodyName = "ChiefBody",
            bodyNameToken = ChiefPlugin.developerPrefix + "_CHIEF_BODY_NAME",
            bodyColor = Color.grey,
            characterPortrait = Modules.Assets.LoadCharacterIcon("Chief"),
            ...
            jumpCount = 1,
            maxHealth = 110f,
            subtitleNameToken = ChiefPlugin.developerPrefix + "_CHIEF_BODY_SUBTITLE",
            podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod")
        };

        internal static Material chiefMat = Modules.Assets.CreateMaterial("matChief");
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = ChiefPlugin.developerPrefix;

            #region Primary
            SkillDef skill_1_1_SkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_CHIEF_BODY_PRIMARY_1_NAME",
                skillNameToken = prefix + "_CHIEF_BODY_PRIMARY_1_NAME",
                skillDescriptionToken = prefix + "_CHIEF_BODY_PRIMARY_1_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texPrimary1Icon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.Chief_SkillPrimary_1)),
            ...
            Modules.Skills.AddPrimarySkill(bodyPrefab, Modules.Skills.CreatePrimarySkillDef(new EntityStates.SerializableEntityStateType(typeof(SkillStates.SlashCombo)), "Weapon", prefix + "_CHIEF_BODY_PRIMARY_SLASH_NAME", prefix + "_CHIEF_BODY_PRIMARY_SLASH_DESCRIPTION", Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texPrimaryIcon"), true));
            #endregion

            #region Secondary
            SkillDef shootSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "_CHIEF_BODY_SECONDARY_GUN_NAME",
                skillNameToken = prefix + "_CHIEF_BODY_SECONDARY_GUN_NAME",
                skillDescriptionToken = prefix + "_CHIEF_BODY_SECONDARY_GUN_DESCRIPTION",
            ...
            {
                skillName = prefix + "_CHIEF_BODY_UTILITY_ROLL_NAME",
                skillNameToken = prefix + "_CHIEF_BODY_UTILITY_ROLL_NAME",
                skillDescriptionToken = prefix + "_CHIEF_BODY_UTILITY_ROLL_DESCRIPTION",
            ...
            {
                skillName = prefix + "_CHIEF_BODY_SPECIAL_BOMB_NAME",
                skillNameToken = prefix + "_CHIEF_BODY_SPECIAL_BOMB_NAME",
                skillDescriptionToken = prefix + "_CHIEF_BODY_SPECIAL_BOMB_DESCRIPTION",
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(ChiefPlugin.developerPrefix + "_CHIEF_BODY_DEFAULT_SKIN_NAME",
            ...
            defaultSkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                ...
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshChiefSword"),
                    renderer = defaultRenderers[0].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshChiefGun"),
                    renderer = defaultRenderers[1].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshChief"),
            ...
            #region MasterySkin
            Material masteryMat = Modules.Assets.CreateMaterial("matChiefAlt");
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(ChiefPlugin.developerPrefix + "_CHIEF_BODY_MASTERY_SKIN_NAME",
            ...
            masterySkin.meshReplacements = new SkinDef.MeshReplacement[]
            {
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshChiefSwordAlt"),
                    renderer = defaultRenderers[0].renderer
                },
                new SkinDef.MeshReplacement
                {
                    mesh = Modules.Assets.mainAssetBundle.LoadAsset<Mesh>("meshChiefAlt"),
                    renderer = defaultRenderers[instance.mainRendererIndex].renderer
                }
            };
